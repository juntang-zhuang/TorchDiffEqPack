...
if TrainMode:
    for _epoch in range(num_epochs):
        ...
        solver = odesolve(func, y0=initial_condition, options=options, return_solver=True)#, time_points=t_list)
        out = solver.integrate(y0 = initial_condition, t0 = options['t0'],t_eval=options['t_eval'])
...
#func.load_state_dict(torch.load(resume))
time_span = np.linspace(0, 2.0, 2000)  # 20 orbital periods and 500 points
