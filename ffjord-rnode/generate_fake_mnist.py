...
def get_parser():
    ...
    parser.add_argument("--resume", type=str, default='experiments/mnist/example_Lambda1.0_v2_0.050.05sym12async0.250.010.001/best.pth', help='path to saved check point')
    parser.add_argument("--save", type=str, default="experiments/mnist/example_Lambda1.0_v2_0.050.05sym12async0.250.010.001")
...
def main():
    ...
    for epoch in range(begin_epoch, begin_epoch + 1):
        ...
        if True:  # args.generate:
            ...
            for t in [ 1.0, 0.95, 0.9, 0.85,  0.8,  0.75, 0.7, 0.65, 0.6]:
