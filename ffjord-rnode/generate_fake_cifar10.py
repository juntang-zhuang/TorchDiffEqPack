...
def get_parser():
    ...
    parser.add_argument("--resume", type=str, default='experiments/cifar10/example_Lambda1.0_v2_0.050.05sym12async0.250.010.001/best.pth', help='path to saved check point')
    parser.add_argument("--save", type=str, default="experiments/cifar10/example_Lambda1.0_v2_0.050.05sym12async0.250.010.001")
